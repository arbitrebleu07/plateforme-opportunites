...
test_opportunities = [
    {
        ...
        'entreprise': 'Opportunity Desk',
        'localisation': 'International',
        'date_limite': '2026-07-31',
        'date_publication': '2026-05-30',
        'source': 'Opportunity Desk',
        'url_source': 'https://opportunitydesk.org/2026/05/30/routledge-round-table-commonwealth-studentship-awards-2026-2027/',
    ...
    },
    {
        ...
        'date_publication': '2026-05-30',
        'source': 'Opportunity Desk',
        'url_source': 'https://opportunitydesk.org/2026/05/30/international-geneva-peace-fellowship-programme-2026/',
    ...
    },
    {
        ...
        'date_publication': '2026-05-30',
        'source': 'Opportunity Desk',
        'url_source': 'https://opportunitydesk.org/2026/05/30/ejn-cop31-climate-change-media-partnership-reporting-fellowship-2026/',
